...
// 	return cryptoJs.AES.encrypt(seed, config.utils.walletSalt).toString();
// };

// export const decryptKey = (cipherText) => {
// 	return cryptoJs.AES.decrypt(cipherText, config.utils.walletSalt).toString(cryptoJs.enc.Utf8);
// };
...
export const getLocalPrivateKey = (app, address, password) => {
	let privateKey = null;
	try {
		const datadir = constant.config.utils.etherDataDirectory;
